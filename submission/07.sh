#!/bin/bash
# Given the following SegWit transaction hex, extract the witness public key
...
# P2WPKH witness: [0] = signature, [1] = pubkey
bitcoin-cli -regtest decoderawtransaction "$transaction" | jq -r '.vin[0].txinwitness[1]'
